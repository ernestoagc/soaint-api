...
public class BaseController {
	...
	private static Logger LOGGER = LogManager.getLogger(BaseController.class);
	  ...
	  @ResponseBody
	  public MensajeResponseDto generalException(HttpServletRequest request, HttpServletResponse response, Exception ex)
	  {
	...
	protected ObjectMapper getObjectMapper()
	 ...
	 public MensajeResponseDto resolverException(HttpServletRequest request, HttpServletResponse response, ValidacionException ex)
	  {
	 ...
	 public void addError(HttpServletResponse response, String code, int status, Object... parametro)
	  ...
	  public MensajeResponseDto resolverException(HttpServletRequest request, HttpServletResponse response, Exception ex)
	  {
		String ticket = request.getHeader("REQUEST_ID");
